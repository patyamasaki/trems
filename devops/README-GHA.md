...
2. Go to your repository at [patyamasaki/trems](https://github.com/patyamasaki/trems).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `trems-patyamasaki.tangrama.com.br` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | trems-patyamasaki.tangrama.com.br | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | trems-patyamasaki.tangrama.com.br |
...
- [Backend Tests Workflow](https://github.com/patyamasaki/trems/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/patyamasaki/trems/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/patyamasaki/trems-backend`) and Frontend (`ghcr.io/patyamasaki/trems-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of trems-patyamasaki.tangrama.com.br](https://github.com/patyamasaki/trems/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/trems-patyamasaki.tangrama.com.br.yml` stack.
