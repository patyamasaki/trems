...
```
DEPLOY_ENV=prod
DEPLOY_HOST=trems-patyamasaki.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    trems-patyamasaki.tangrama.com.br:
      ansible_user: root
      host: trems-patyamasaki
      hostname: trems-patyamasaki.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/trems-patyamasaki.tangrama.com.br.yml` to the remote server with:
